...
def plotMaps_pcolormesh(data, figName, values, mapa, lons2d, lats2d, lat, lon, data_model, data_station):
  '''
  ...
  for l1, l2, item1, item2 in zip(lat, lon, data_model, data_station):
 #        print(item)
 #        print(stations)
 #        print
    x, y = b(l2, l1)
